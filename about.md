...
I developed several algorithms and applications during my time in Oxford. I made a simple Android app📱 such that everyone can explore a city easily (<a href="https://github.com/edenau/CheckPoint-APP" target="_blank">GitHub</a>), a simple algorithm that calibrates a pinhole camera
📷 (<a href="https://github.com/edenau/Camera-Calibration" target="_blank">GitHub</a>), and a distributed optimization algorithm for increasing service level of station-based bike sharing systems🚴 (<a href="https://github.com/edenau/Bike-Sharing-Systems-Optimization" target="_blank">GitHub</a>).
